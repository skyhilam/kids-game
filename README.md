...
## 開始玩
電腦：用瀏覽器開啟 [線上版本](https://game1.iclover.net/kids-game/)，或本機開啟 `index.html`，按「開始遊戲」。
...
## 關卡
1. 沿路前行：熟習輕觸操作，沿路購買漢堡。
2. 先購漢堡：辨認通往漢堡店的道路，學習先後次序。
3. 小小探路家：探索有分岔與盡頭的小路。
4. 繞路尋店：漢堡店不在通往公園的捷徑上。
5. 雙路並行：上下兩條走廊，須先到店再入園。
6. 盡頭探險：更多盡頭路，須小心選擇。
右上角「？」可選擇關卡及查看遊戲說明。
