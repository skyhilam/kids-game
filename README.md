...
本機專案內含三款小路遊戲；同一路段僅可通行一次。新增的送貨遊戲須部署後才會出現於線上版本。

- **一起去野餐**：先到漢堡店，再前往公園。
- **打敗蛀牙蟲**：走到終點，途中不可遇到蛀牙蟲。
- **送貨員來了**：從紅色起點畫線，依序到 1、2、3 號屋貼上包裹，再到藍色終點。
...
按住藍色小車，沿白色道路畫線；小車跟隨操作前進，放手可停下並從原位續畫。偏離道路時回到小車旁再繼續。到達房子後，按「貼包裹」才完成該站。先送 1、2、3 號屋，再到藍色終點。可以重經路口，但不能重走路段，包括反方向。

亦可切換「點選路口」，使用箭嘴或方向鍵。切換方式會回到最近完成的路口，保留已完成路段和送貨記錄，未畫完的一段會清除。「？」內有規則及家長引導。完整對照與共用模組見 [送貨遊戲說明](docs/DELIVERY_GAME.md)。

## 野餐關卡
開頭幾關熟習操作，之後會一直出現新的小路，過關即可再玩下一張。刷牙遊戲同樣一路玩下去。送貨目前仍是一張地圖。
...
不保存個人資料，重新載入會回到遊戲選單。
野餐與刷牙的音效可用右上角喇叭關閉；送貨目前提供文字及圖像回饋。
